...
public class GameSetupTest extends AndroidTestCase {
	...
	public void testBaneCard(){
	    ...
	    try {
	        gameSetup.setBaneCard(new DominionCard(0, "card too cheap", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
	    ...
	    try {
            gameSetup.setBaneCard(new DominionCard(0, "card too expensive", 4, true, false, false, false, false, false, false, DominionSet.Dominion));
            assertTrue("IllegalArgumentException expected to be thrown", false);
        } catch (IllegalArgumentException e) {
            assertEquals("Bane card must have cost of 2 or 3.", e.getMessage());
        }
	    
	    DominionCard card = new DominionCard(0, "Card cost OK", 2, true, false, false, false, false, false, false, DominionSet.Dominion);
	    gameSetup.setBaneCard(card);
	    assertEquals(card, gameSetup.getBaneCard().getItem());
	    assertEquals(10, gameSetup.getBaneCard().getCount());
	    
	    card = new DominionCard(0, "Card cost OK", 2, true, false, false, false, true, false, false, DominionSet.Dominion);
        gameSetup.setBaneCard(card);
        assertEquals(card, gameSetup.getBaneCard().getItem());
	...
	private ArrayList<DominionCard> createSimpleKingdomCardList(){
		...
		// Regular card:
		kingdomCardsReference.add(new DominionCard(0, "card 1", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		// Victory card:
		kingdomCardsReference.add(new DominionCard(0, "card 2", 1, true, false, false, false, true, false, false, DominionSet.Dominion));
		// More regular cards:
		kingdomCardsReference.add(new DominionCard(0, "card 3", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 4", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 5", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 6", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 7", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 8", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 9", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
		kingdomCardsReference.add(new DominionCard(0, "card 10", 1, true, false, false, false, false, false, false, DominionSet.Dominion));
