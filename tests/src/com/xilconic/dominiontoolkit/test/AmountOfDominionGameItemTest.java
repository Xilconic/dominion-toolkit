...
public class AmountOfDominionGameItemTest extends AndroidTestCase {
	...
	public void testAmountOfDominionGameItemAsCard(){
		DominionCard item = new DominionCard(1, "test", 2, true, false, false, false, false, false, false, false, false, false, false, DominionSet.Basic);
		AmountOfDominionGameItem itemToTest = new AmountOfDominionGameItem(item, 3);
	...
	public void testParcelableCreator(){
		...
		item = new DominionCard(1, "test", 2, true, false, false, false, false, false, false, false, false, false, false, DominionSet.Basic);
