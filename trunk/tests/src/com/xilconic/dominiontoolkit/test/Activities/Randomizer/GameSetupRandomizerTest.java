...
public class GameSetupRandomizerTest extends AndroidTestCase{
    ...
    public void testGetRandomKingdomDeckYoungWitchSetsBaneCard(){
        ArrayList<DominionCard> collection = new ArrayList<DominionCard>();
        collection.add(new DominionCard(1, "t1", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(2, "t2", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(3, "t3", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(4, "t4", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(5, "t5", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(6, "t6", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(7, "t7", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(8, "t8", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(9, "t9", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(new DominionCard(10, "t10", 2, true, false, false, false, false, false, DominionSet.Dominion));
        collection.add(CardsDB.Cornucopia.YoungWitch);
        ArrayList<DominionCard> cardpool = randomizer.getCardpool();
        cardpool.clear();
        cardpool.addAll(collection);
